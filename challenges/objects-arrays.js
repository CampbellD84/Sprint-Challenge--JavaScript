...
const trex = new Dinosaur('tyrannosaurus', 'carnivorous','7000kg', '12m', 'Late Cretaceious');
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stego = new Dinosaur('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
const velo = new Dinosaur('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceious');
...
*/
const populationTotal = zooAnimals.reduce((accVal, currVal) => {
  return accVal + currVal.population;
}, 0);
